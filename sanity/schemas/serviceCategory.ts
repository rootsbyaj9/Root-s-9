...
export const serviceCategory = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      type: "string",
      group: "basics",
      description: 'What is this group of services called? e.g. "Hair Masterclass", "Skin Rituals", "Bridal Makeover"',
    ...
    defineField({
      name: "displayTabs",
      title: "Which tabs does this appear under? (Multi-select)",
      type: "array",
      group: "basics",
      description: "Pick all tabs where this service category should appear (e.g. select both Women's, Men's, and Piercing to display in all 3). Overrides the single tab selection below.",
      of: [{ type: "string" }],
      options: {
        list: [
          { title: "💆 Women's",               value: "womens"  },
          { title: "💈 Men's",                  value: "mens"    },
          { title: "👰 Bridal Makeover",         value: "bridal"  },
          { title: "🖋 Tattoo Artistry",          value: "tattoo"  },
          { title: "💅 Nail Art & Styling",      value: "nails"   },
    ...
    defineField({
      name: "gender",
      title: "Primary / Single Tab (Legacy)",
      type: "string",
      group: "basics",
      description: "Fallback tab for single selection. Use the checkboxes above to show in multiple tabs.",
      options: {
        list: [
          { title: "💆 Women's",               value: "womens"  },
          { title: "💈 Men's",                  value: "mens"    },
