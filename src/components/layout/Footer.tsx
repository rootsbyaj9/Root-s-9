...
// ── Data (replace with Sanity in Milestone 3) ─────────────────────────────────
const QUICK_LINKS = [
  { label: "Home", href: "/" },
...
const CONTACT = {
  ...
  phone: "+91 95500 71714",
  whatsapp: "919550071714",
};
...
const SOCIAL = [
  ...
  {
    label: "Facebook",
    href: "https://www.facebook.com/anikanth.jadhav.1",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" className="w-4 h-4">
